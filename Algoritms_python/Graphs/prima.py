...
R = [(math.inf, -1, -1), (113, 1, 2), (18, 1, 3), (17, 1, 4), (14, 1, 5), (22, 1, 6),
...
# math.inf => Возвращает положительную бесконечность, значение которое является типом float
# Если нет ни одного ребра, то возращается картеж (math.inf, -1, -1) 